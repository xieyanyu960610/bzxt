    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.IntegerField(choices=[(1, '超级管理员'), (2, '管理员'), (3, '普通用户')], help_text='权限标识', verbose_name='权限标识')),
                ('picUrl', models.ImageField(blank=True, null=True, upload_to='user/', verbose_name='头像路径')),
